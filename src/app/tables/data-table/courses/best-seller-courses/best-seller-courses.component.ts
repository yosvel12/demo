...
@Component({
    selector: 'app-best-seller-courses:not(p)',
    standalone: true,
    imports: [RouterLink, MatCardModule, MatMenuModule, MatButtonModule, MatTableModule, MatPaginatorModule, NgIf, MatTooltipModule],
    templateUrl: './best-seller-courses.component.html',
    styleUrl: './best-seller-courses.component.scss'
})
export class BestSellerCoursesComponent {
