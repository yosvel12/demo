...
@Component({
    selector: 'app-table',
    standalone: true,
    imports: [RouterLink, MatCardModule, BasicTableComponent, StylingColumnsUtagColumnNamesComponent, AddingRemovingDataWuaabDatasourceComponent, DynamicallyChangingColumnsDisplayedComponent, ArDataWuaObservableBasedDatasourceComponent, TwExpandableRowsComponent, TableWithFilteringComponent, FooterRowTableComponent, MultipleHeaderFooterRowsComponent, DtwSortingPaginationFilteringComponent, TableWithPaginationComponent, TwReOrderableColumnsComponent, TableWithSelectionComponent, TableWithSortingComponent, TableWithStickyColumnsComponent, TableWithStickyFooterComponent, TableWithStickyHeaderComponent, TwMaterialDesignRipplesComponent],
