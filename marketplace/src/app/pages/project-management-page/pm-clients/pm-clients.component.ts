...
export class PmClientsComponent {
    ...
    clientCard = [
        {
            clientImg: `images/clients/client1.png`,
        ...
        {
            clientImg: `images/clients/client2.png`,
        ...
        {
            clientImg: `images/clients/client3.png`,
        ...
        {
            clientImg: `images/clients/client4.png`,
        ...
        {
            clientImg: `images/clients/client5.png`,
        ...
        {
            clientImg: `images/clients/client6.png`,
        ...
        {
            clientImg: `images/clients/client7.png`,
        ...
        {
            clientImg: `images/clients/client8.png`,
        ...
        {
            clientImg: `images/clients/client9.png`,
        ...
        {
            clientImg: `images/clients/client10.png`,
        ...
        {
            clientImg: `images/clients/client11.png`,
        ...
        {
            clientImg: `images/clients/client12.png`,
